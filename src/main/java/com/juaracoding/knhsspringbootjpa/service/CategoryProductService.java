...
import com.juaracoding.knhsspringbootjpa.repo.CategoryProductRepo;
...
public class CategoryProductService {
    ...
    public ResponseEntity<Object> saveUploadFile(List<CategoryProduct> listCategoryProduct,
        ...
        try
        {
            ...
            {
//                strExceptionArr[1]="saveUploadFile(List<CategoryProductDTO> listCategoryProduct, MultipartFile multipartFile, WebRequest request)---LINE67";
//                LoggingFile.exceptionStringz(strExceptionArr,new ResourceNotFoundException(ConstantMessage.ERROR_EMPTY_FILE +" -- "+multipartFile.getOriginalFilename()), OtherConfig.getFlagLogging());
        ...
        catch (Exception e)
        {
            ...
            strExceptionArr[1]="saveUploadFile(List<CategoryProductDTO> listCategoryProduct, MultipartFile multipartFile, WebRequest request) --- LINE 77";
