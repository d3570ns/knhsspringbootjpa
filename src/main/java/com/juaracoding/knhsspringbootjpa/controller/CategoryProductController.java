...
import com.juaracoding.knhsspringbootjpa.dto.CategoryProductDTO;
...
import com.juaracoding.knhsspringbootjpa.service.CategoryProductService;
import com.juaracoding.knhsspringbootjpa.utils.ConstantMessage;
import com.juaracoding.knhsspringbootjpa.utils.CsvReader;
import com.juaracoding.knhsspringbootjpa.utils.ExcelReader;
...
public class CategoryProductController {
    ...
    List<com.juaracoding.knhsspringbootjpa.model.CategoryProduct> lsCPUpload = new ArrayList<com.juaracoding.knhsspringbootjpa.model.CategoryProduct>();
    ...
    @PostMapping("/v1/s")
    public ResponseEntity<Object> saveCategory(@Valid @RequestBody com.juaracoding.knhsspringbootjpa.model.CategoryProduct categoryProduct){
    ...
    @PostMapping("/v1/sl")
    public ResponseEntity<Object> saveCategoryList(@Valid@RequestBody List<com.juaracoding.knhsspringbootjpa.model.CategoryProduct> listCategoryProduct){
    ...
    @PutMapping("/v1/sl/{id}")
    public ResponseEntity<Object> updateCategoryById(@Valid @RequestBody com.juaracoding.knhsspringbootjpa.model.CategoryProduct categoryProduct, @PathVariable Long id) throws Exception {
    ...
    public ResponseEntity<Object> findAll(){
        ...
        List<com.juaracoding.knhsspringbootjpa.model.CategoryProduct> ls = categoryProductService.findAllCategory();
    ...
    public ResponseEntity<Object> findAllPagination(@PathVariable("size") Integer sizez,@PathVariable("page") Integer pagez,@PathVariable("sort") String sortz){
        ...
        Page<com.juaracoding.knhsspringbootjpa.model.CategoryProduct> page = categoryProductService.findAllCategoryByPage(pageable);
    ...
    public ResponseEntity<Object> findAllPagination2(@PathVariable("size") Integer sizez,@PathVariable("page") Integer pagez,@PathVariable("sort") String sortz){
        ...
        Page<com.juaracoding.knhsspringbootjpa.model.CategoryProduct> page = categoryProductService.findAllCategoryByPage(pageable);
        List<com.juaracoding.knhsspringbootjpa.model.CategoryProduct> listCategoryProduct = page.getContent();
    ...
    */
    ...
    public ResponseEntity<Object> findPaginationSortByDTO1(@PathVariable("size") Integer sizez,@PathVariable("page") Integer pagez,@PathVariable("sort") String sortz,@PathVariable("sortby") String sortzBy){
        ...
        List<CategoryProductDTO> listCategoryProductDTODTO = modelMapper.map(listCategoryProduct, new TypeToken<List<CategoryProductDTO>>() {}.getType());
...
//        CategoryProductDTO categoryProductDTO = modelMapper.map(categoryProduct, new TypeToken<CategoryProductDTO>() {}.getType());
        objectMapper.put("data", listCategoryProductDTODTO);
    ...
    */
    ...
    public ResponseEntity<Object> findPaginationSortByDTO2(@PathVariable("size") Integer sizez,@PathVariable("page") Integer pagez,@PathVariable("sort") String sortz,@PathVariable("sortby") String sortzBy){
        ...
        List<CategoryProductDTO> listCategoryProductDTODTO = modelMapper.map(listCategoryProduct, new TypeToken<List<CategoryProductDTO>>() {}.getType());
        Map<String, Object> mapResult = transformObject(objectMapper, listCategoryProductDTODTO,page);
    ...
    public List<com.juaracoding.knhsspringbootjpa.model.CategoryProduct> csvToCategoryProduct(InputStream inputStream) throws Exception {
        BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(inputStream, "UTF-8"));
        CSVParser csvParser = new CSVParser(bufferedReader,
                CSVFormat.DEFAULT.withFirstRecordAsHeader().
                        withIgnoreHeaderCase()
        );
//        lsCPUpload = new ArrayList<CategoryProductDTO>();
        lsCPUpload.clear();
        ...
        try {
            ...
            for (CSVRecord record : iterRecords) {
                com.juaracoding.knhsspringbootjpa.model.CategoryProduct cProducts = new com.juaracoding.knhsspringbootjpa.model.CategoryProduct();
    ...
    public List<com.juaracoding.knhsspringbootjpa.model.CategoryProduct> excelToCategoryProduct(InputStream inputStream) throws Exception {
